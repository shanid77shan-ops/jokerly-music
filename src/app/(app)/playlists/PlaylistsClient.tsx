    ...
    <div className="w-full space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          style={{ background: "#e53935", boxShadow: "0 4px 16px rgba(240,165,0,0.30)" }}
        >
          <Plus size={15} /> New
        </button>
      </div>
      ...
      {creating && (
        <div className="rounded-2xl p-5 space-y-3 border" style={{ background: "var(--surface)", borderColor: "rgba(240,165,0,0.20)" }}>
          ...
          <input
            ...
            className="w-full border text-white placeholder-white/25 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#e53935]/60 transition-all"
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#e53935] hover:bg-[#a93226] disabled:opacity-40 text-white font-semibold text-sm transition-colors"
            >
              ...
              >
                ...
                >
                  ...
                  <div className="relative shrink-0 w-12 h-12">
                    ...
                    {isPinned && (
                      <span className="absolute -top-1 -right-1 w-3.5 h-3.5 rounded-full bg-[#e53935] border-2 border-[var(--card)]" />
                    )}
                  </div>
                  ...
                  {edit?.id === pl.id ? (
                    <div className="flex flex-1 gap-2 min-w-0">
                      <input
                        ...
                        className="flex-1 min-w-0 border text-white rounded-xl px-3 py-1.5 text-sm focus:outline-none focus:border-[#e53935]/60 transition-all"
                        style={{ background: "var(--surface)", borderColor: "rgba(255,255,255,0.08)" }}
                      />
                      <button onClick={saveEdit} disabled={saving}
                        className="shrink-0 px-3 py-1.5 rounded-xl bg-[#e53935] hover:bg-[#a93226] text-white text-sm font-medium transition-colors">
                  ...
                  <div className="flex items-center gap-0.5 shrink-0">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-xl transition-colors"
                      style={{
                        color: isPinned ? "#e53935" : "rgba(255,255,255,0.28)",
